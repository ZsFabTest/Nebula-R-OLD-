    ...
    public override void ButtonInitialize(HudManager __instance)
    {
        ...
        killButton = new CustomButton(
            () =>
            {
                ...
                if ((int)Game.GameData.data.GetPlayerData(Game.GameData.data.myData.currentTarget.PlayerId).GetExtraRoleData(Roles.AvengerTarget) == Game.GameData.data.myData.getGlobalData().GetRoleData(loversId) || killable)
                {
