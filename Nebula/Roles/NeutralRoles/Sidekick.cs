...
public class Sidekick : Role
{
    ...
    public override void MyPlayerControlUpdate()
    {
        if (killButton != null)
        {
            ...
            (player) =>
            {
                ...
                else if (player.GetModData().role == Roles.BlueCat) return false;
                return true;
            });
    ...
    public override void EditDisplayNameColor(byte playerId, ref Color displayColor)
    {
        ...
        }else if(PlayerControl.LocalPlayer.GetModData().role == Roles.BlueCat) displayColor = Roles.Jackal.Color;
    }
