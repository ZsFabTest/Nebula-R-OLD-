...
public class Jackal : Role
{
    ...
    public override void LoadOptionData()
    {
        ...
        CreateSidekickCoolDownOption = CreateOption(Color.white, "createSidekickCoolDownOption", 20f, 10f, 30f, 5f).AddPrerequisite(CanCreateSidekickOption);
    ...
    public override void MyPlayerControlUpdate()
    {
        ...
        data.currentTarget = Patches.PlayerControlPatch.SetMyTarget(
            (player) =>
            {
                ...
                if (player.GetModData().role == Roles.BlueCat)
                {
                    return false;
                }
                return true;
    ...
    private void ChangeSidekickToJackal(byte playerId)
    {
        ...
        foreach (Game.PlayerData player in Game.GameData.data.AllPlayers.Values)
        {
            ...
            else
            {
                ...
                if (player.role == Roles.BlueCat) continue;
    ...
    public override void EditDisplayNameColor(byte playerId, ref Color displayColor)
    {
        ...
        }else if(PlayerControl.LocalPlayer.GetModData().role == Roles.BlueCat) displayColor = RoleColor;
    }
