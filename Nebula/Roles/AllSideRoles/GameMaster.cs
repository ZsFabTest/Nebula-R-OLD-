...
public class GameMaster : Role
{
    public class GMEvent : Events.LocalEvent
    {
        ...
        {
            RPCEventInvoker.AddExtraRole(target, Roles.SecondaryBait, 0);            
        }
    }
    ...
    public GameMaster()
        : base("GM", "gm", Roles.OnlineCelebrity.Color, RoleCategory.Neutral, Side.ChainShifter, Side.ChainShifter,
