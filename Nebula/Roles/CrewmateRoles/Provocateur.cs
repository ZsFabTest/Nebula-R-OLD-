...
public class Provocateur : Role
{
    ...
    public class RevievEvent : Events.LocalEvent
    {
        public RevievEvent() : base(0.1f)
        {
        }
    ...
    private Module.CustomOption maxRevievNumberOption;
    ...
    public int revievDataId { get; private set; }
    public override RelatedRoleData[] RelatedRoleDataInfo
    {
        get => new RelatedRoleData[] {
            new RelatedRoleData(revievDataId, "Provocateur Reviev", 0, 15) };
    }
    public override void GlobalInitialize(PlayerControl __instance)
    {
        __instance.GetModData().SetRoleData(revievDataId, 0);
    }
    ...
    public override void OnMurdered(byte murderId)
    {
        ...
        if(PlayerControl.LocalPlayer.GetModData().GetRoleData(revievDataId) < maxRevievNumberOption.getFloat())
        {
            Events.LocalEvent.Activate(new RevievEvent());
            RPCEventInvoker.AddAndUpdateRoleData(PlayerControl.LocalPlayer.PlayerId, revievDataId, 1);
        }
    }
    ...
    public override void LoadOptionData()
    {
        ...
        maxRevievNumberOption = CreateOption(Color.white, "maxRevievNumber", 1f, 0f, 5f, 1f);
    }
    ...
    {
        revievDataId = Game.GameData.RegisterRoleDataId("provocateur.reviev");
    }
}